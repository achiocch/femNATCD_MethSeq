...
model0 = "group~Matsmk+Matagg+FamScore+EduPar+Matagg+FamScore+EduPar+n_trauma+Age+int_dis+medication+n_trauma+Age+int_dis+medication+contraceptives+V8+cigday_1+Epi"
